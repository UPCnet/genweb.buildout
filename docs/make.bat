...
set BUILDDIR=/Development/ulearn.buildout/docs
set ALLSPHINXOPTS=-d %BUILDDIR%/doctrees %SPHINXOPTS% /Development/ulearn.buildout/docs
set I18NSPHINXOPTS=%SPHINXOPTS% /Development/ulearn.buildout/docs
if NOT "%PAPER%" == "" (
